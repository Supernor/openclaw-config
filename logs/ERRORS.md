...
fatal: unable to auto-detect email address (got 'node@0f4945af5233.(none)')
```
...
**Stderr:**
```
{"status":"ERROR","message":"Push failed","pushed":false}
```
...
**Message:** /home/node/.openclaw/scripts/env-backup.sh failed (exit 1): {"status":"ERROR","message":"env file not found"}
**Exit code:** `1`
**Stderr:**
```
{"status":"ERROR","message":"env file not found"}
```
...
**Stderr:**
```
{"status":"ERROR","message":"env file not found","file":"/app/.env"}
```
